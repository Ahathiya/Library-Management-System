...
public class AddNewBook extends javax.swing.JFrame {
    ...
    private void c3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c3ActionPerformed
        if(c3.getSelectedItem()=="Information Technology")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("First Year");c4.addItem("Second Year");c4.addItem("Third Year");c4.addItem("Fourth Class");
        }
        if(c3.getSelectedItem()=="Mechnical")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("First Year");c4.addItem("Second Year");c4.addItem("Third Year");c4.addItem("Fourth Class");        
        }
        if(c3.getSelectedItem()=="Electronic")
        {
            c4.removeAllItems();
            c4.addItem("Select Class");c4.addItem("First Year");c4.addItem("Second Year");c4.addItem("Third Year");c4.addItem("Fourth Class");        
        }
