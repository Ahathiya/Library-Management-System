...
public class IssuedBooks extends javax.swing.JFrame {
    ...
    private void c1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_c1ActionPerformed
        if(c1.getSelectedItem()=="Information Technology")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("First Year");c2.addItem("Second Year");c2.addItem("Third Year");c2.addItem("Fourth Year");
        }
        if(c1.getSelectedItem()=="Mechnical")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("First Year");c2.addItem("Second Year");c2.addItem("Third Year");c2.addItem("Fourth Year");
        }
        if(c1.getSelectedItem()=="Electronic")
        {
            c2.removeAllItems();
            c2.addItem("Select Class");c2.addItem("First Year");c2.addItem("Second Year");c2.addItem("Third Year");c2.addItem("Fourth Year");        }
